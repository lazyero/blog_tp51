...
<div class="layui-tab layui-tab-brief">
    ...
    <div class="layui-tab-content">
        ...
        <form action="" method="post" class="ajax-form">
            选中项：
            <button type="button" class="layui-btn layui-btn-danger layui-btn-small ajax-action" data-action="<?php echo e(url('delete')); ?>">删除</button>
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($v['update_time']); ?></td>
                        <td>
                            <a href="<?php echo e(url('edit?id='.$v['id'])); ?>" class="layui-btn layui-btn-normal layui-btn-xs">编辑</a>
                            <a href="<?php echo e(url('delete?id='.$v['id'])); ?>" class="layui-btn layui-btn-danger layui-btn-xs ajax-delete">删除</a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
