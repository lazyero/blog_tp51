    ...
    <div class="top">
        ...
        <div class="submit">
            <div class="submitcode">
                ...
                <div class="code">
                    <div class="code-img">
                        <img  src="<?php echo e(captcha_src()); ?>" alt="点击更换" title="点击更换" onclick="this.src='<?php echo e(captcha_src()); ?>?time='+Math.random()" class="captcha" name="codeimage" id="codeimage" border="0"/>
                   </div>
                    <a href="JavaScript:void(0);" id="hide" class="close" title="关闭"><i></i></a><a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='<?php echo e(captcha_src()); ?>';" class="change" title="看不清,点击更换验证码"><i></i></a>
                </div>
            </div>
...
<script>
    $(function(){
        ...
        $('.btn-submit').click(function(data){
        	...
        	$('.submit').fadeOut();
        	$.ajax({
                url: "<?php echo e(url('syslogin/login')); ?>",
                type: 'post',
