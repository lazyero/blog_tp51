                ...
                <div class="container">
                    ...
                    <div id="top-navbar-collapse" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $names): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $names['child']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="dropdown">
                                    ...
                                    <div class="ui segment piled">
                                        <div class="extra content tag-active-user-card">
                                            <div class="ui middle aligned divided list">
                                                <div class="ui items">
                                                    <div class="item">
                                                        <a class="image" href="<?php echo e(url('article')); ?>?id=<?php echo e($list['id']); ?>">
                                                            <img class="ui image image-shadow " src="<?php echo e($list['img_url']); ?>">
                                                        </a>
                                                        <div class="content">
                                                            <div class="header" style="width:100%">
                                                                <a href="<?php echo e(url('article')); ?>?id=<?php echo e($list['id']); ?>" class="ui text black">
                                                            ...
                                                            <div class="extra">
                                                                <a class="ui button teal" href="<?php echo e(url('article')); ?>?id=<?php echo e($list['id']); ?>">文章详情</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
