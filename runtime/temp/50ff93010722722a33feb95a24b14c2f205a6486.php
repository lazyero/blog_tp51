...
<div class="layui-tab layui-tab-brief">
    <ul class="layui-tab-title">
        ...
        <li class=""><a href="<?php echo e(url('sysadmin/group_add')); ?>">添加角色</a></li>
    ...
    <div class="layui-form-item">
        ...
        <!-- <input type="hidden" id="group_id" name="id" value="<?php echo e($id); ?>"> -->
...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            url: "<?php echo e(url('sysadmin/getJson')); ?>",
            type: "post",
            dataType: "json",
            cache: false,
            data: {
        ...
        $("#auth-btn").on("click", function () {
            ...
            $.ajax({
                url: "<?php echo e(url('sysadmin/updateAuthGroupRule')); ?>",
                type: "post",
                cache: false,
                data: {
                    id: _id,
