...
<div class="layui-tab layui-tab-brief">
    ...
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <form class="layui-form form-container" action="<?php echo e(url('sysmenu/save')); ?>" method="post">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="pid" lay-verify="required">
                            ...
                            <option value="<?php echo e($v['id']); ?>" <?php if($pid == $v['id']): ?>selected <?php endif; ?>><?php if($v['level']!=1): ?> <?php for($i=1;$i<$v['level'];$i++): ?> ---- <?php endfor; ?> <?php endif; ?> <?php echo e($v['title']); ?></option>
