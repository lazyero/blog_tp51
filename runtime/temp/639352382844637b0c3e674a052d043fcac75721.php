   ...
   <div class="l_div" style="width: 46.5%;float: left;">
       <table class="layui-table larry-table-info">
           ...
           <tr>
               ...
               <td><span class="info iframe"><?php echo e($web['site_title']); ?></span></td>
           </tr>
           <tr>
           ...
           <tr>
               ...
               <td><span class="info"><a href="http://<?php echo e($_SERVER['HTTP_HOST']); ?>" class="official" target="_blank">http://<?php echo e($_SERVER['HTTP_HOST']); ?></a></span></td>
           </tr>
           <tr>
           ...
           <tr>
               ...
               <td><?php echo e($_SERVER['DOCUMENT_ROOT']); ?></td>
           </tr>
           <tr>
    ...
    <div class="r_div" style="width: 52.5%;float: right;">
        <table class="layui-table larry-table-info">
            ...
            <tr>
                ...
                <td><a href="http://www.huisheng.com/about" target="_blank"><?php echo e($web['site_title']); ?>项目组</a></td>
            </tr>
            <tr>
